...
5. v4 - основанный на v3 добавлена оптимизация поиска, когда в начала паттерна есть несколько одинаковых байт
6. v4.1 - тот же алгоритм v4, но с использованием подстановочных знаков wildcards в паттернах поиска и замены
