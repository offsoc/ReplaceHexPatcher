...
- При работе в окне/терминале Powershell, запущенном от имени Администратора - относительные пути могут вдруг стать относительными относительно папки System32
