...
- [ ] Реализовать функции StartsWith и EndsWith для проверки, что файл начинается или заканчивается указанным набором байт
- [ ] Реализовать оптимизации поиска для ускорения поиска
  - [ ] Оптимизация поиска в случае, когда паттерн поиска начинается с wildcard-символов или заканчивается ими
  ...
  - [ ] Оптимизация поиска, когда паттерн поиска начинается последовательностью одинаковых символов
...
- [x] Реализовать функцию поиска hex-паттерна начиная с определенного смещения в файле или начиная с определенной части файла в %
